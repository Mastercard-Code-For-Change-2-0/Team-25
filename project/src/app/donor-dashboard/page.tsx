          ...
          <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">Contribute to student education</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold mb-2">My Donations</h3>
                <p className="text-gray-600">View your donation history</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold mb-2">Impact Reports</h3>
            ...
            <div className="mt-6 p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-green-700">Donor Type: {user.donorType}</p>
